...
growth_hacking = Product.create(title: "Growth Hacking", 
	...
	price: "4.99", sku: "GROHACK1", download_url: "https://s3.amazonaws.com/bruce-one-month-stripe-payments/Reference+List.pdf", details: "You'll get one video", description: %{<p>A growth hacker is a rare combination: someone with the right marketing and technical skills who can come up with clever marketing hacks and also track their results.</p>
...
growth_hacking_monthly = Product.create(title: "Growth Hacking Monthly", 
    ...
    price: "4.99", sku: "GROHACK2", download_url: "https://s3.amazonaws.com/bruce-one-month-stripe-payments/Reference+List.pdf", 
